...
from src.utils.print_logs import print_agents, print_agents_aviality
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("3. View agents availability")
        print("4. View Shared Key for register gateway")
        print("5. View All Logs")
        print("6. Save Logs in CSV")
        print("7. Exit")
        ...
        if option == '1':
            ...
            agents_registered = get_all_agents_registered()
            print("==============================================================================================================================")
            print_agents_aviality(agents_registered)
            print("==============================================================================================================================")
        elif option == '4':
            ...
            server_yellow_page.verify_agents_availability()
